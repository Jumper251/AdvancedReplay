...
public class ItemConfigOption {
    ...
    public ItemConfigOption(Material material, String name, int slot, String owner, int data, String texture) {
        this(material, name, slot);
        this.data = data;
        this.owner = owner;
    ...
    public ItemConfigOption(Material material, String name, int slot, String texture) {
        this(material, name, slot);
        this.texture = texture;
    }
